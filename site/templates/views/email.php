    ...
    <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" bgcolor="#F0F0F0">
        <tr>
            <td align="center" valign="top" bgcolor="#F0F0F0" style="background-color: #F0F0F0;">
                <!-- Branding header -->
                <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#3b5a6f">
                    <tr>
                        <td align="center" valign="top" bgcolor="#F0F0F0" style="background-color: #3b5a6f;">
                            <center>
                                <!-- Logo (branding) -->
                                <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width: 600px; max-width: 600px;">
                                    <tr>
                                        <td class="container-padding footer-text" align="left" style='padding-top: 12px; padding-bottom: 12px;'>
                                            <br>
                                            <span style='color: #FFFFFF; font-family: Helvetica, Arial, sans-serif; font-size: 32px; font-weight: bold;'><?php echo $page->title; ?> <?php echo $page->sitename; ?></span>
                                            <br>
                                        </td>
                                    </tr>
                                </table>
                                <!-- white space -->
                                <table border="0" width="100%" cellpadding="0" cellspacing="0" class="container" style="width: 100%; max-width: 600px;" bgcolor="#FFFFFF">
                                    <tr>
                    ...
                    <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width: 600px; max-width: 600px;">
                        ...
                        <tr>
                            <td class="container-padding footer-text" align="center" style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; line-height: 16px; color: #aaaaaa;">
                                <br>
                                <span style='color: #b1b1b1'><?php echo $this->_("Sent from"); ?> <b><?php echo $page->title; ?></b></span>
                                <br>
                            </td>
                        </tr>
                    </table>
