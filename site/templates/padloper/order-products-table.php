...
?>
<table class="inventory uk-table uk-table-responsive">
  <thead>
    <tr>
...
<table class="balance">
  <tbody>
    <tr>
      <th><span><h3><?= __("Total") ?></h3></span></th>
      <td><span><h3><b><?= $cart->renderPriceAndCurrency($order->pad_price_total) ?></b></h3></span></td>
    </tr>
    <?php
