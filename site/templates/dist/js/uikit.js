    ...
    UIkit.component('countdown', {
        ...
        methods: {
            ...
            start: function start() {
                ...
                this.timer = setInterval(function () { return this$1.update(); }, 100);
            },
            ...
            update: function update(){
                ...
                ['days','hours','minutes','seconds'].forEach(function (item) {

                    if (!this$1[item].text().trim() || Number(this$1[item].text()) !== Number(t[item])) {

                        digit = String(t[item] < 10 ? '0'+t[item]: t[item]);

                        this$1[item].html(digit.split('').map(function (n) { return ("<span>" + n + "</span>"); }).join(''));
                    }
                });
